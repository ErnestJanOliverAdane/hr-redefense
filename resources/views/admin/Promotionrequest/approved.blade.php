...
@section('content')
    <div class="container-fluid px-4">
        <h1 class="mt-4">Approved Promotion Requests</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="{{ url('/admin/dashboard') }}">Dashboard</a></li>
            <li class="breadcrumb-item active">Approved Promotion Requests</li>
        </ol>
            ...
            <div class="card-body">
                <table id="datatablesSimple" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="8" class="text-center">No approved promotion requests found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
