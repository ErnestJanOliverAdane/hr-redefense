...
@section('content')
    <div class="container">
        ...
        <p class="mt-3">
            This is to certify that the name above has actually rendered services in this office as shown by the service
            record below,
            each line of which is supported by appointment and other papers actually issued by this office and approved by
